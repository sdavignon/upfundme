  ...
  render() {
    ...
    return (
      <div className="shifted">
        <Helmet>
          <title>{intl.formatMessage({ id: 'invite', defaultMessage: 'Invite' })} - UPFund.me</title>
        </Helmet>
          ...
          <div className="center">
            <div className="Invite">
              ...
              <h1 className="Invite__title">
                <FormattedMessage id="invite_title" defaultMessage="Don't use UPFund.me alone!" />
              </h1>
              <p className="Invite__description">
                <FormattedMessage
                  id="invite_info"
                  defaultMessage="Onboard new users on UPFund.me today using the link below and get 10% of their rewards for 30 days."
                />
              </p>
              ...
              <div className="Invite__social">
                ...
                <TwitterShare
                  ...
                  text={intl.formatMessage(
                    {
                      id: 'invite_share',
                      defaultMessage: 'Join me today on UPFund.me and get rewarded to post items for sale {link}',
                    },
                    {
                      link: '',
                    },
                ...
                <EmailShare
                  ...
                  text={intl.formatMessage(
                    {
                      id: 'invite_share',
                      defaultMessage: 'Join me today on UPFund.me and get rewarded to post for sale {link}',
                    },
                    {
