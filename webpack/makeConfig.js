  ...
  let plugins = [
    new webpack.DefinePlugin({
      'process.env': {
        ...
        STEEMCONNECT_CLIENT_ID: JSON.stringify(process.env.STEEMCONNECT_CLIENT_ID || 'upfundme.app'),
        STEEMCONNECT_REDIRECT_URL: JSON.stringify(
          process.env.STEEMCONNECT_REDIRECT_URL || 'https://upfundme.herokuapp.com/callback',
        ),
